...
import { forwardRef, createElement, createContext, Component, PureComponent, cloneElement, Children } from 'react';
...
var createComponentFactory = function (key) {
    var componentFactory = function (poseConfig) {
        ...
        return forwardRef(function (_a, ref) {
            ...
            return !withParent || props.parentValues ? (createElement(PoseElement, __assign({ poseConfig: poseConfig, innerRef: ref, elementType: key }, props))) : (createElement(PoseParentConsumer, null, function (parentCtx) { return (createElement(PoseElement, __assign({ poseConfig: poseConfig, elementType: key, innerRef: ref }, props, parentCtx))); }));
        });
    };
