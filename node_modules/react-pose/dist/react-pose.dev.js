(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var dragAction = /*#__PURE__*/__assign$3({}, intelligentTransition, { x: /*#__PURE__*/createPointer(pointerX, 'left', 'right', BoundingBoxDimension.width), y: /*#__PURE__*/createPointer(pointerY, 'top', 'bottom', BoundingBoxDimension.height) });
    var justAxis = function (_a) {
        var from = _a.from;
        return just(from);
    };
    var intelligentDragEnd = /*#__PURE__*/__assign$3({}, intelligentTransition, { x: justAxis, y: justAxis });
    ...
    var getAction = function (v, _a, _b) {
        ...
        return animationLookup[type](__assign$3({}, baseProps, def));
    };
    ...
    var createPoseConfig = function (element, _a) {
        ...
        var poseConfig = __assign$3({ flip: {} }, config, { props: __assign$3({}, config.props, { onDragStart: onDragStart,
                onDragEnd: onDragEnd,
        ...
        if (draggable) {
            var _b = dragPoses(draggable),
                drag = _b.drag,
                dragEnd = _b.dragEnd;
            poseConfig.drag = __assign$3({}, poseConfig.drag, drag);
